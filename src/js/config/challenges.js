         ...
         const CHALLENGES = [
           {
             ...
             hint:'bulb Look for peaks or valleys — local extrema!',
           ...
           },
           {
             ...
             hint:'bulb Look for the point where gradient is largest',
             check:(fn,x0) => {
           ...
           },
           {
             ...
             hint:'bulb Where the curve bends the most sharply',
             check:(fn,x0) => {
